...
const parentsDetails = require("./parentsDetails/parentsDetails.service.js");
const programmeDetails = require("./programmeDetails/programmeDetails.service.js");
const programmeChoice = require("./programmeChoice/programmeChoice.service.js");
...
module.exports = function (app) {
  ...
  app.configure(parentsDetails);
  app.configure(programmeDetails);
  app.configure(programmeChoice);
