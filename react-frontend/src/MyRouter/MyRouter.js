...
import SingleParentsDetailsPage from "../components/ParentsDetailsPage/SingleParentsDetailsPage";
import ParentsDetailProjectLayoutPage from "../components/ParentsDetailsPage/ParentsDetailProjectLayoutPage";
import SingleProgrammeDetailsPage from "../components/ProgrammeDetailsPage/SingleProgrammeDetailsPage";
import ProgrammeDetailProjectLayoutPage from "../components/ProgrammeDetailsPage/ProgrammeDetailProjectLayoutPage";
import SingleProgrammeChoicePage from "../components/ProgrammeChoicePage/SingleProgrammeChoicePage";
import ProgrammeChoiceProjectLayoutPage from "../components/ProgrammeChoicePage/ProgrammeChoiceProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/parentsDetails/:singleParentsDetailsId" exact element={<SingleParentsDetailsPage />} />
<Route path="/parentsDetails" exact element={<ParentsDetailProjectLayoutPage />} />
...
<Route path="/programmeChoice/:singleProgrammeChoiceId" exact element={<SingleProgrammeChoicePage />} />
<Route path="/programmeChoice" exact element={<ProgrammeChoiceProjectLayoutPage />} />
