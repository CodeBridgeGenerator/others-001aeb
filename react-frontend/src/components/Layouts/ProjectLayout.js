...
import ParentsDetailsPage from "../ParentsDetailsPage/ParentsDetailsPage";
import ProgrammeDetailsPage from "../ProgrammeDetailsPage/ProgrammeDetailsPage";
import ProgrammeChoicePage from "../ProgrammeChoicePage/ProgrammeChoicePage";
// ~cb-add-import~
...
<li
                onClick={() => {
                  setCurrentActiveTab2("parentsDetails");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "parentsDetails",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "parentsDetails" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "parentsDetails",
                      "text-black": props?.currentActiveTab2 !== "parentsDetails",
                    })}
                  >
                  ParentsDetails
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "parentsDetails",
                      "text-yellow-700": props?.currentActiveTab2 !== "parentsDetails",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("programmeDetails");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "programmeDetails",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "programmeDetails" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "programmeDetails",
                      "text-black": props?.currentActiveTab2 !== "programmeDetails",
                    })}
                  >
                  ProgrammeDetails
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "programmeDetails",
                      "text-yellow-700": props?.currentActiveTab2 !== "programmeDetails",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("programmeChoice");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "programmeChoice",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "programmeChoice" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "programmeChoice",
                      "text-black": props?.currentActiveTab2 !== "programmeChoice",
                    })}
                  >
                  ProgrammeChoice
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "programmeChoice",
                      "text-yellow-700": props?.currentActiveTab2 !== "programmeChoice",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
